...
public class CalculatriceTest {
    ...
    public void testAdditionner() {
        ...
        // Ici, vous devez utiliser une méthode existante de la classe Calculatrice pour vérifier son état
        // Par exemple, si la classe Calculatrice a une méthode 'getResultat()', vous pouvez l'utiliser comme suit :
       // verify(calculatrice).getResultat();
    }
}
